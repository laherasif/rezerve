...
import { Scroll } from '@/components/GenericData/Scroller';
...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
    ...
    return (
        <div>
            ...
            <div
                className={`fixed inset-0 bg-slate-900 bg-opacity-30 md:hidden transition-opacity duration-200 ${sidebarOpen
                    ? "opacity-100 z-50"
            ...
            <div
                className={` flex flex-col md:hidden w-full  transition-opacity duration-300 transform ease-in-out rounded-tr-[20px] rounded-tl-[20px] fixed l z-[999] bottom-0 left-0  ${sidebarOpen
                    ? "opacity-100"
                    : "opacity-0 pointer-events-none"
                        ...
                        <ul className="flex flex-col justify-center mx-[20px] p-0 my-[20px] gap-[10px]">
                            ...
                            <li>
                                <Scroll setSidebarOpen={setSidebarOpen} to="joinUs">
                                    <div className='flex justify-between group hover:bg-[#176B87] delay-150 text-[#176B87] hover:text-white cursor-pointer border-[#176B87] items-center gap-2  border-[2px] rounded-lg w-full  px-5 h-[48px]'>
                                        <span suppressHydrationWarning>{t('joinWait')}</span>
                            ...
                            <li className="flex justify-between gap-2 items-center">
                                <div className='w-full'>
                                    <div href="" target="_blank"
                                        className="flex items-center cursor-pointer border justify-center w-full  px-2 text-center text-white bg-white rounded"
                                        rel="noreferrer">
                                ...
                                <div className='w-full'>
                                    ...
                                    <div href=""
                                        ...
                                        <div className="flex flex-col ml-2 py-1 text-left">
                                            <span className="text-[10px] text-black">{t('comingSoon')}</span>
                                            <span className="text-base leading-4/= font-normal text-black">
                                            Apple App Store
                                            </span>
                                        </div>
                                    </div>
